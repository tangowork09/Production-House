...
// ── Generate live items from renamed img-3.jpg through img-37.jpg ──
const rawItems = Array.from({ length: 33 }).map((_, i) => ({
  type: "portrait",
  src: `/images/img-${i + 3}.jpg`,
  alt: `Prince Movie Creation Production Frame ${i + 3}`,
}));
...
export default function Gallery() {
  ...
  function scrollTrack(dir) {
    trackRef.current?.scrollBy({
      left: dir * Math.round(window.innerWidth * 0.6),
      behavior: "smooth",
    });
  }
